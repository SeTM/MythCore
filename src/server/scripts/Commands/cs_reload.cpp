...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "gameguard",                    SEC_ADMINISTRATOR, true,  &HandleReloadAntiCheatCommand,                  "", NULL },
    ...
    {
        sLog->outString("Re-Loading GameGard config table...");
        sObjectMgr->LoadAntiCheatConfig();
        handler->SendGlobalGMSysMessage("GameGuard config reloaded.");
        return true;
    }
