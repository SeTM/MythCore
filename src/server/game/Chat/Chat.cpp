...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand characterCommandTable[] =
    {
        ...
        { "rename",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleCharacterRenameCommand>,        "", NULL },
        { "reputation",     SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleCharacterReputationCommand>,    "", NULL },
        { "titles",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleCharacterTitlesCommand>,        "", NULL },
        { NULL,             0,                  false, NULL,                                                          "", NULL }
    };
    ...
    {
        { "create",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGuildCreateCommand>,         "", NULL },
        { "delete",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGuildDeleteCommand>,         "", NULL },
        { "invite",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGuildInviteCommand>,         "", NULL },
        { "uninvite",       SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGuildUninviteCommand>,       "", NULL },
        { "rank",           SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGuildRankCommand>,           "", NULL },
        { NULL,             0,                  false, NULL,                                                       "", NULL }
    };
    ...
    {
        { "ip",             SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupPlayerIpCommand>,       "", NULL },
        { "account",        SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupPlayerAccountCommand>,  "", NULL },
        { "email",          SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupPlayerEmailCommand>,    "", NULL },
        { NULL,             0,                  false, NULL,                                                        "", NULL }
    };

    static ChatCommand lookupCommandTable[] =
    {
        { "area",           SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupAreaCommand>,          "", NULL },
        { "creature",       SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupCreatureCommand>,      "", NULL },
        { "event",          SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupEventCommand>,         "", NULL },
        ...
        { "tele",           SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupTeleCommand>,          "", NULL },
        { "title",          SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupTitleCommand>,         "", NULL },
    ...
    {
        { "create",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleCreatePetCommand>,           "", NULL },
        { "learn",          SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandlePetLearnCommand>,            "", NULL },
        { "unlearn",        SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandlePetUnlearnCommand>,          "", NULL },
        { "tp",             SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandlePetTpCommand>,               "", NULL },
        { NULL,             0,                  false, NULL,                                                       "", NULL }
    };
    ...
    static ChatCommand sendCommandTable[] =
    {
        ...
        { "mail",           SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleSendMailCommand>,            "", NULL },
    ...
    {
        { "corpses",        SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleServerCorpsesCommand>,     "", NULL },
    ...
    {
        { "append",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketResponseAppendCommand>,   "", NULL },
        { "appendln",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketResponseAppendLnCommand>, "", NULL },
        { NULL,             0,                  false, NULL,                                                            "", NULL }
    };

    static ChatCommand ticketCommandTable[] =
    {
        { "list",           SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketListCommand>,             "", NULL },
        { "onlinelist",     SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketListOnlineCommand>,       "", NULL },
        { "viewname",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketGetByNameCommand>,        "", NULL },
        { "viewid",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketGetByIdCommand>,          "", NULL },
        { "close",          SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketCloseByIdCommand>,        "", NULL },
        { "closedlist",     SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketListClosedCommand>,       "", NULL },
        { "escalatedlist",  SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketListEscalatedCommand>,    "", NULL },
        { "delete",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketDeleteByIdCommand>,       "", NULL },
        { "assign",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketAssignToCommand>,         "", NULL },
        { "unassign",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketUnAssignCommand>,         "", NULL },
        { "comment",        SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketCommentCommand>,          "", NULL },
        { "togglesystem",   SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleToggleGMTicketSystem>,            "", NULL },
        { "escalate",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketEscalateCommand>,         "", NULL },
        { "response",       SEC_ADMINISTRATOR,  false, NULL,                                                            "", ticketResponseCommandTable },
        { "complete",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGMTicketCompleteCommand>,         "", NULL },
        { NULL,             0,                  false, NULL,                                                            "", NULL }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "pet",            SEC_ADMINISTRATOR,  false, NULL,                                           "", petCommandTable },
        { "ticket",         SEC_ADMINISTRATOR,  false, NULL,                                          "", ticketCommandTable },
        ...
        { "nameannounce",   SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleNameAnnounceCommand>,        "", NULL },
        { "gmnameannounce", SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGMNameAnnounceCommand>,      "", NULL },
        { "announce",       SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleAnnounceCommand>,            "", NULL },
        { "gmannounce",     SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGMAnnounceCommand>,          "", NULL },
        { "notify",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleNotifyCommand>,              "", NULL },
        { "gmnotify",       SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleGMNotifyCommand>,            "", NULL },
        { "appear",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleAppearCommand>,              "", NULL },
        { "summon",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleSummonCommand>,              "", NULL },
        { "groupsummon",    SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGroupSummonCommand>,         "", NULL },
        { "commands",       SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleCommandsCommand>,            "", NULL },
        { "demorph",        SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleDeMorphCommand>,             "", NULL },
        ...
        { "gps",            SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGPSCommand>,                 "", NULL },
        { "guid",           SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleGUIDCommand>,                "", NULL },
        { "help",           SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleHelpCommand>,                "", NULL },
        { "itemmove",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleItemMoveCommand>,            "", NULL },
        ...
        { "recall",         SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleRecallCommand>,              "", NULL },
        { "save",           SEC_PLAYER,         false, OldHandler<&ChatHandler::HandleSaveCommand>,                "", NULL },
        { "saveall",        SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleSaveAllCommand>,             "", NULL },
        { "kick",           SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleKickPlayerCommand>,          "", NULL },
        ...
        { "taxicheat",      SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleTaxiCheatCommand>,           "", NULL },
        ...
        { "whispers",       SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleWhispersCommand>,            "", NULL },
        { "pinfo",          SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandlePInfoCommand>,               "", NULL },
        ...
        { "mute",           SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleMuteCommand>,                "", NULL },
        { "unmute",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleUnmuteCommand>,              "", NULL },
        ...
        { "combatstop",     SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleCombatStopCommand>,          "", NULL },
        { "flusharenapoints", SEC_ADMINISTRATOR, true, OldHandler<&ChatHandler::HandleFlushArenaPointsCommand>,    "", NULL },
        { "repairitems",    SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleRepairitemsCommand>,         "", NULL },
        { "waterwalk",      SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleWaterwalkCommand>,           "", NULL },
...
int ChatHandler::ParseCommands(const char* text)
{
    ...
    if (m_session && m_session->GetSecurity() <= SEC_VIP && sWorld->getBoolConfig(CONFIG_ALLOW_PLAYER_COMMANDS) == 0)
       return 0;
