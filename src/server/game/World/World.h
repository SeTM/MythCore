...
enum WorldBoolConfigs
{
    ...
    CONFIG_GAMEGUARD_ENABLE,
    CONFIG_GAMEGUARD_WARDEN_ENABLE,
    CONFIG_PREMIUM_ENABLE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_GAMEGUARD_GMLEVEL,
    CONFIG_GAMEGUARD_ACTION_DELAY,
    CONFIG_PREMIUM_GMLEVEL,
...
enum Rates
{
    ...
    RATE_MOVESPEED,
    RATE_XP_PREMIUM_KILL,
    RATE_XP_PREMIUM_QUEST,
    RATE_XP_PREMIUM_EXPLORE,
    RATE_PREMIUM_REPUTATION_GAIN,
    RATE_PREMIUM_HONOR,
...
class World
{
    public:
        ...
        void SendWorldTextWithSecurity(AccountTypes sec, int32 string_id, ...);
        void SendGlobalText(const char* text, WorldSession* self);
        void SendGMText(int32 string_id, ...);
        void SendGlobalMessage(WorldPacket* packet, WorldSession* self = 0, uint32 team = 0, AccountTypes sec = SEC_PLAYER);
